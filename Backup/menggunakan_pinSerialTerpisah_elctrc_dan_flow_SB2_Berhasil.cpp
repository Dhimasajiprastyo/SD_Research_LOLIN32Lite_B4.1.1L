...
String serializeData(Config configs) { //PENGAMBILAN DATA SENSOR-----------
...
sensor_serial_set(0);
delay(100);
// sensor_serial1.updateBaudRate(9600);
