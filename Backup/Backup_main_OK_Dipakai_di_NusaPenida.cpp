...
void setAlarmTwo(int intervalGetData) {
  ...
  Serial.println("Reset alarm2");
  // if ((next_kirim_data < next_ambil_data) || (next_ambil_data == 0)) {
  //   uint8_t dif = 0;
  ...
  //     if (next_ambil_data == 0) {
  //       add_t_kirim = 60 + 2 - now.Minute();
  //     } else {
  //       add_t_kirim = next_ambil_data + 2 - now.Minute(); sdfsdf; //yg ini menitnya tambah 1 aja biar aman, yg penting alarm 1 belakangan
  //     }
