...
class Menu {
  private:
    const String        rootMenu[MAX_ROOT_MENU] = {"1.Setting", "2.Sleep", "3.Status", "4.Data", "5.Test", "6.Del-Rules", "7.SD menu", "8.MISC_Sensor","9.Battery safe","10.Min Signal","11.Date Time","12.DEF.SETTINGS","13.Exit"};
