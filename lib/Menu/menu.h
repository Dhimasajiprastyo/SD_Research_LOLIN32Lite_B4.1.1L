...
class Menu {
  private:
    const String        rootMenu[MAX_ROOT_MENU] = {"1.Setting", "2.Analog", "3.Status", "4.Data", "5.Test", "6.APN", "7.SD menu", "8.MISC_Sensor","9.Battery safe","10.Min Signal","11.Burst Send","12.DEF.SETTINGS","13.Exit"};
